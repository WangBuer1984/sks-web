...
还原后：5594 行；其中前约 4080 行是 505 条 `@font-face` 内嵌字体，App 标记从 4084 行起。
...
| 7 | 主区域（容器） | — | `div` | 4281–5070 | 3 | `sections/07-主区域.html` | src/components/AppLayout.tsx  （layout route） |
...
| 10 | 校准对话 | `isCalib` | `sc-if` | 4433–4503 | 70 | `sections/10-校准对话.html` | src/pages/Calibrate.tsx  (/calibrate) |
| 11 | 账号定位 | `isPos` | `sc-if` | 4505–4563 | 58 | `sections/11-账号定位.html` | src/pages/Positioning.tsx  (/positioning) |
| 12 | 选题库 | `isTopics` | `sc-if` | 4565–4596 | 31 | `sections/12-选题库.html` | src/pages/Topics.tsx  (/topics) |
| 13 | 文案创作 | `isCreate` | `sc-if` | 4598–4727 | 129 | `sections/13-文案创作.html` | src/pages/Create.tsx  (/create) |
| 14 | 对标拆解 | `isBench` | `sc-if` | 4729–4920 | 191 | `sections/14-对标拆解.html` | src/pages/Analyze.tsx  (/analyze) |
| 15 | 知识库 | `isKb` | `sc-if` | 4922–4985 | 63 | `sections/15-知识库.html` | src/pages/KB.tsx  (/kb) |
| 16 | 历史稿件 | `isHistory` | `sc-if` | 4987–5069 | 82 | `sections/16-历史稿件.html` | src/pages/Review.tsx  (/review) —— UI 标题应对齐「发布复盘」 |
